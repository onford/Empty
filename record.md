...
本科期间我还做了许多科研。我认为最早的科研是美国大学生数学建模竞赛，这是一个团队比赛，前期我和队友做了长时间的准备；拿到赛题的时候立刻组织讨论，围绕问题提出idea，构建框架，分工合作，奋斗三个日夜完成了论文的撰写和提交。我享受这种思考问题、提出自己的解法的过程，享受这种把一个idea用系统严谨的latex论文表述出来的美感。随后有两个课程设计，硬件综合训练和操作系统课程设计，前者让我利用各种shuzi。进入武汉国家广电研究中心，我先参加了一个基于tinykv的暑期项目，获得关于分布式数据库的大致理解；然后在实验室实习，协助师兄发表了一篇B会论文（europar），获得有关分布式大模型训练的理解。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc5OTQ5NjA1NiwtMTcwMzk4NTk1OCwtMT
Q3MTQ5MTg5NSwxMzY5OTY1MjI2LDExOTU3ODAzMTUsLTE1NjE1
NjAzMzQsMTI4NTQwMDExNSwxODkxMDIwNjQ2LC0yNjk4MDI2ND
RdfQ==
-->