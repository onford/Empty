...
我本科选修的专业是计算机科学与技术，本科前五个学期的加权成绩名列前茅，加权排名位于专业的前3%。本科期间我在数据结构、数据库系统原理、操作系统、组成原理等专业核心课程中均取得了优异的成绩。
本科期间我还参加了许多竞赛，包括全国大学生数学竞赛、美国大学生数学建模竞赛，以及后续的一系列算法比赛。数学竞赛和建模竞赛提高了我的数学思维、建模和理性思考能力，而各种算法竞赛ze
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg0NTU1NjgyMSwtMTQ3MTQ5MTg5NSwxMz
