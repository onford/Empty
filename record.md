...
因为有成绩和竞赛的加成，我在本科期间获得了一些奖项，包括国家奖学金、自强奖学金等，连续两年获校三好奖学金。这些奖学金是对我不懈努力的认可，也化作了我前行路上的动力。
本科期间我还做了许多科研。我认为最早的科研是美国大学生数学建模竞赛，这是一个团队比赛，前期我和队友做了长时间的准备；拿到赛题的时候立刻组织讨论，围绕问题提出idea，构建框架，分工合作，奋斗三个日夜完成了论文的撰写和提交。我享受这种思考问题、提出自己的解法的过程，享受这种把一个idea用系统严谨的latex论文表述出来的美感。随后有两个课程设计，硬件综合训练和操作系统课程设计，前者让我利用各种数字电路模块搭建了自己独创的CPU，后者让我体会到操作系统是一个极其庞大的项目，而模块化的思路正是面对复杂项目的良好解决方案。进入武汉国家光电研究中心，我先参加了一个基于tinykv的暑期项目，获得关于分布式数据库的大致理解；然后在实验室实习，协助师兄发表了一篇B会论文（europar），获得有关分布式大模型训练的理解。
在经过这些科研之后，我感觉自己的兴趣还是落在系统结构研究，希望能够从事相关的研究工作。如果在读研期间，我的能力获得了导师的认可，并且我对系统结构的兴趣有增无减的话，我想我会考虑继续攻读博士学位。争取将来能进高校或研究所从事我所喜欢的职业，最终成为一名优秀的研究者。
以上就是我的介绍，谢谢各位老师。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNzE0MzQ1ODAsLTE3MDM5ODU5NTgsLT
E0NzE0OTE4OTUsMTM2OTk2NTIyNiwxMTk1NzgwMzE1LC0xNTYx
NTYwMzM0LDEyODU0MDAxMTUsMTg5MTAyMDY0NiwtMjY5ODAyNj
Q0XX0=
-->